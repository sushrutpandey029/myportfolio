...
- **Full CRUD Operations**: Create, read, update, and delete Services, Projects, Skills, Team Members, and Study Materials.
...
│   │   └── routes.py            # Contact form processing
...
│   │   └── routes.py            # Home, about, and static page routes
...
│       ├── 151641f0bba8_add_icon_image_field_to_skills_table.py  # Skills icon field
│       ├── 194e474b5504_add_google_drive_link_to_projects.py    # Project Google Drive links
│       ├── 20d509b55559_add_servicecategory_and_update_service.py # Service categories
│       ├── 4d324a25eaa8_add_projectcategory_and_category_id_to_.py # Project categories
│       ├── 5952f6e8a588_add_new_dynamic_fields_to_aboutcontent.py # About page fields
│       ├── 5fa0a4cfa54e_initial_migration.py                    # Initial schema
│       ├── 62d3604cca08_add_github_link_to_projects.py          # Project GitHub links
│       ├── 6e2669ffbf87_add_aboutcontent_model.py               # About content model
│       ├── 6f95bf866aa0_add_blog_posts_table.py                 # Blog posts table
│       ├── 70c8bde30da9_add_youtubecategory_model.py            # YouTube categories
│       ├── b57e3f52a873_add_skill_categories_table.py           # Skill categories
│       ├── c00c0d49346d_add_homecontent_model.py                 # Home content model
│       ├── e1278bf90a4d_add_home_page_dynamic_content_models.py  # Home page models
│       ├── ea9c0143f5d5_add_blog_categories.py                  # Blog categories
│       └── f942598eb413_add_doc_url_field_to_studymaterial.py   # Study material URLs
...
- **Contact Management**: Inquiries and contact forms
